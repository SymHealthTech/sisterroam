...
export const metadata = {
  ...
  description:
    "One small one-time $5 fee for lifetime verified status. No subscriptions, no hidden charges. SisterRoam is free to join.",
  openGraph: {
    type: "website",
    ...
    description:
      "One small one-time $5 fee for lifetime verified status. Free to join.",
    images: [{ url: "/sisterroam-og-image.png", width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Pricing — One-Time Verification Fee — SisterRoam",
    description: "$5 one-time, lifetime verified status. Free to join SisterRoam.",
          ...
          <div className="max-w-3xl mx-auto px-6">
            <div className="max-w-sm mx-auto mb-12">
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand to-brand-dark p-8 text-white">
                <p className="text-white/60 text-xs font-semibold uppercase tracking-wider mb-3">Verified membership</p>
                <p className="text-5xl font-bold leading-none mb-1">$5</p>
            ...
            <div className="space-y-5">
              ...
              {[
                ...
                },
                {
                  ...
                  a: "We accept all major credit and debit cards and other popular payment methods via our secure payment provider.",
                },
              ].map(({ q, a }) => (
