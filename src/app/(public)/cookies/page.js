      ...
      <main>
        ...
        <div className="bg-brand-lighter pt-[60px]">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10">
            <h1 className="text-3xl font-bold text-brand-darker mb-2">Cookie Policy</h1>
          ...
          <div className="space-y-10">
            <Section title="1. What are cookies?">
              <p>
                ...
                a website. They allow the site to remember information about your visit — such as
                whether you are logged in — so you do not have to re-enter it on every page.
              </p>
            </Section>

            <Section title="2. Cookies we use">
              <p>SisterRoam uses only essential cookies. We do not use advertising, analytics, or tracking cookies.</p>
              <div className="overflow-x-auto">
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="text-left py-2 pr-4 font-semibold text-gray-700 w-1/3">Cookie</th>
                      <th className="text-left py-2 pr-4 font-semibold text-gray-700 w-1/3">Purpose</th>
                      <th className="text-left py-2 font-semibold text-gray-700 w-1/3">Duration</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    <tr>
                      <td className="py-2 pr-4 font-mono text-xs">next-auth.session-token</td>
                      <td className="py-2 pr-4">Keeps you logged in between page loads</td>
                    ...
                    <tr>
                      ...
                      <td className="py-2 pr-4">Remembers where to redirect you after login</td>
                      <td className="py-2">Session</td>
                    </tr>
                  </tbody>
                </table>
            ...
            <Section title="3. Third-party cookies">
              <p>
                We do not load any third-party scripts that set their own cookies. Our payment
                provider (Cashfree) and media host (Cloudinary) process data on their own domains
            ...
            <Section title="4. Managing cookies">
              <p>
                ...
                let you refuse new cookies, delete existing ones, or alert you before a cookie
                is set. Disabling our essential cookies will prevent you from staying logged in
                and using authenticated features of the platform.
              </p>
            ...
            <Section title="5. Changes to this policy">
              <p>
                ...
                this page with an updated date. Continued use of SisterRoam after changes take
