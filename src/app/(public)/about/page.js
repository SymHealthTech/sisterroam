...
const STATS = [
  ...
  { value: '35', label: 'Age she started trekking — proving it\'s never too late' },
  { value: '4,200+', label: 'Community followers' },
]

const PHOTO_CARDS = [
  { bg: 'bg-brand-lighter', icon: Mountain, color: 'text-brand', label: 'Kilimanjaro' },
  { bg: 'bg-teal-lighter', icon: Mountain, color: 'text-teal', label: 'Elbrus' },
  { bg: 'bg-amber-lighter', icon: Bike, color: 'text-amber', label: 'Xpulse 210' },
  { bg: 'bg-pink-lighter', icon: Map, color: 'text-pink', label: 'India Road Trips' },
  { bg: 'bg-gray-100', icon: Globe, color: 'text-gray-400', label: 'World Travels' },
]
...
const AWARDS = [
  ...
  { title: 'Adventure & Mountaineering Achievement', subtitle: 'Award · Organisation' },
      ...
      <main>
        ...
        <section className="bg-brand py-24 md:py-20 pt-36 md:pt-28">
          <div className="max-w-3xl mx-auto text-center px-6">
            ...
            <p className="text-white/70 text-lg leading-relaxed mt-5 max-w-2xl mx-auto">
              SisterRoam was not built in a boardroom. It was built by a woman who
              has climbed two of the world&apos;s Seven Summits, run a clinic for 18
              years, led an NGO for women&apos;s empowerment, and knows exactly what
              female solo travellers need — because she is one.
            </p>
        ...
        <section id="founder" className="bg-white py-24 md:py-20">
          <div className="max-w-6xl mx-auto px-8">
            <div className="grid grid-cols-1 md:grid-cols-[42fr_58fr] gap-12 md:gap-20 items-start">
              ...
              {/* Photo column */}
              <div>
                <div className="relative rounded-2xl overflow-hidden" style={{ height: 540 }}>
                  <Image
                  ...
                  <div className="absolute bottom-4 left-4 bg-white rounded-xl px-4 py-3 shadow-md">
                    ...
                    <div className="flex items-center gap-1.5 mb-1">
                      <Mountain className="w-4 h-4 text-brand shrink-0" aria-hidden="true" />
                      <span className="text-xs text-gray-600">Kilimanjaro 5,895m</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <Mountain className="w-4 h-4 text-brand shrink-0" aria-hidden="true" />
                      <span className="text-xs text-gray-600">Elbrus 5,642m</span>
                    </div>
                  </div>
                </div>

                <div className="mt-3">
                  <p className="text-sm font-medium text-gray-700">Dr Manisha Sonawane</p>
                  <p className="text-xs text-gray-500">Founder &amp; Brand Ambassador</p>
                  <a
              ...
              <div>
                ...
                <h2 className="text-3xl font-medium text-gray-900">Dr Manisha Sonawane</h2>
                <p className="text-sm text-gray-400 mt-1 mb-6">43 · Pune, India · Mother of two</p>
                ...
                <div className="mt-6">
                  ...
                  <p className="font-serif text-xl italic text-brand">Dr Manisha Sonawane</p>
                ...
                <div className="bg-gray-50 rounded-xl px-4 py-3 mt-4 flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400">Canada&apos;s Holistic Health Practitioner Directory</p>
                  </div>
                  <a
                    href="https://nutracare360.ca"
                    target="_blank"
        ...
        <section id="timeline" className="bg-gray-50 py-20 md:py-20">
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl font-medium text-gray-900">A life lived fully</h2>
            ...
            <div className="relative max-w-2xl mx-auto">
              {/* Vertical line */}
              <div className="absolute left-[11px] top-0 bottom-0 w-0.5 bg-brand/20" aria-hidden="true" />
                  ...
                  return (
                    <div key={item.year + item.title} className="relative pl-10">
                      ...
                      <div
                        ...
                        aria-hidden="true"
                      >
                        <div className={`rounded-full bg-white ${item.special ? 'w-2.5 h-2.5' : 'w-2 h-2'}`} />
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-gray-100 p-5">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <h3 className={`font-medium text-gray-900 mt-0.5 ${item.special ? 'text-base' : 'text-sm'}`}>
                              {item.title}
                            </h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-center">
              {STATS.map(({ value, label }) => (
                <div key={value + label}>
                  ...
                  <p className="text-white/60 text-sm mt-1 leading-tight">{label}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <div className="mt-5 space-y-4 text-sm text-gray-600 leading-relaxed">
                  <p>
                    Long before SisterRoam existed, Dr Manisha was already working to make the world
                    safer and healthier for women. As the President of Shraddha Seva Pratishthan, she
                    has spent years on the ground — working on women&apos;s empowerment, addressing
                    health challenges in women and young girls, and building the kind of community that
                    SisterRoam is now bringing online.
                  </p>
                  <p>
                    SisterRoam is a natural extension of this work. The NGO serves women in person.
                    SisterRoam serves women who travel. Both are built on the same belief: women are
                    safer, stronger, and more capable when they have a community they can trust.
                  </p>
                  <p>
                    As a mother of two sons, Dr Manisha also brings a unique perspective — she is
                    raising the next generation to understand and support women&apos;s independence,
                    safety, and ambition.
                  </p>
                </div>
              </div>
              ...
              <div>
                <div className="bg-brand rounded-2xl p-6 text-white">
                  <p className="text-lg font-medium text-white">Shraddha Seva Pratishthan</p>
                  <p className="text-white/70 text-sm mt-1">President — Dr Manisha Sonawane</p>
                ...
                <div className="bg-white rounded-xl p-4 mt-4 border border-gray-100">
                  <div className="flex items-start gap-3">
                    <Globe className="w-4 h-4 text-brand shrink-0 mt-0.5" aria-hidden="true" />
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-gray-700">International venture</p>
                      <p className="text-xs text-gray-500 mt-0.5">Co-founder, Nutracare 360 Incorporation</p>
                      <p className="text-xs text-gray-500">Canada&apos;s Holistic Health Practitioner Directory</p>
                      <a
                        href="https://nutracare360.ca"
                        target="_blank"
                        rel="noopener noreferrer"
        ...
        <section className="bg-white py-16">
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl font-medium text-gray-900">Awards and achievements</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {AWARDS.map(({ title, subtitle }) => (
                <div key={title} className="bg-amber-lighter rounded-2xl p-5 flex items-start gap-3">
            ...
            <p className="text-xs text-gray-400 italic text-center mt-6">
              More achievements to be added — Dr Manisha has received multiple recognitions across
              medicine, mountaineering, and women&apos;s empowerment.
            </p>
          </div>
        </section>
        ...
        <section className="bg-brand-lighter py-20">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <h2 className="text-2xl font-medium text-brand-darker mb-8">Why SisterRoam exists</h2>
            ...
            <blockquote className="font-serif text-lg text-brand-dark leading-relaxed italic text-left">
              <p className="mb-4">
                I have climbed Kilimanjaro and Elbrus. I have ridden my motorcycle through Himalayan
                passes. I have done road trips from one end of India to the other. I have walked
                through six countries as a traveller, a doctor, and a woman. And in every single
                place, I met women who were travelling alone and making do with whatever safety they
                could find for themselves.
              </p>
              <p className="mb-4">
                SisterRoam is what I kept wishing existed. Not a hotel booking site. Not a Facebook
                group. A real, verified, caring community of women who open their homes and their
                cities to other women they can trust.
              </p>
              <p>
                I built it because I am tired of waiting. And because the women who deserve it cannot
                wait any longer.
              </p>
            </blockquote>

            <div className="w-12 h-0.5 bg-brand mx-auto my-5" />
            <p className="font-serif text-base italic text-brand">— Dr Manisha Sonawane</p>
        ...
        <section id="contact" className="bg-white py-20 md:py-20">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <h2 className="text-2xl font-medium text-gray-900">We would love to hear from you</h2>
            <p className="text-sm text-gray-500 leading-relaxed mt-3 mb-10">
              Dr Manisha and the SisterRoam team read every message. Whether you have a question,
        ...
        <section className="bg-brand py-20">
          <div className="max-w-xl mx-auto px-6 text-center">
            ...
            <p className="text-white/70 text-base leading-relaxed mt-4">
              A doctor who has climbed two of the Seven Summits built SisterRoam for every woman who
              travels alone and deserves a community she can trust.
            </p>
            ...
            <p className="text-white/40 text-xs mt-4">
              No credit card required · Verified within 48 hours · 100% free to join
            </p>
          </div>
        </section>
      </main>
