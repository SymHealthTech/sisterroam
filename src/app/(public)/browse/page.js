    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-b border-gray-100 px-4 py-8 text-center">
          <h1 className="text-2xl font-bold text-gray-900">Find a Host Sister</h1>
          <p className="mt-1 text-sm text-gray-500 max-w-md mx-auto">
            Browse verified women hosts worldwide. Sign up free to send a stay request.
          </p>
        </div>
        ...
        <div className="flex min-h-full">
          ...
          <div className="hidden lg:block w-[280px] shrink-0 border-r border-gray-100 bg-white sticky top-0 self-start overflow-y-auto max-h-screen px-5 py-5">
          ...
          <div className="flex-1 min-w-0 px-4 py-5 lg:px-6 space-y-5">
            ...
            {!isLoading && hosts.length === 0 && (
              <div className="text-center py-16 space-y-3">
                ...
                <h3 className="text-base font-semibold text-gray-900">No hosts found</h3>
                <p className="text-sm text-gray-500">
                  {filters.country
