...
export default function OnboardingProfilePage() {
  ...
  const [prevSessionUser, setPrevSessionUser] = useState(null);
  ...
  const [fetchedForCountry, setFetchedForCountry] = useState(null);
  ...
  if (session?.user && session.user !== prevSessionUser) {
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <span
                className={cn(
                  "text-[11px]",
                  bioLength > 480 ? "text-amber" : "text-gray-400",
                )}
              >
                {bioLength}/500
              </span>
