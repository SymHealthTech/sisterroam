        ...
        <div
          ...
          className={cn(
            ...
            s === current
              ? "w-6 h-2.5 bg-brand"
              : s < current
                ? "w-2.5 h-2.5 bg-brand opacity-40"
...
function DialCodePicker({ value, onChange }) {
  ...
  const selected =
    DIAL_CODES.find((d) => d.code === value && d.country === "India") ??
          ...
          <div className="max-h-52 overflow-y-auto">
            {filtered.map((d) => (
              ...
              >
                ...
                <span className="font-medium text-gray-700 w-12 shrink-0">
                  {d.code}
                </span>
              ...
              <form onSubmit={handleSubmit(handleStep1)} className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Used for emergency contact — not verified at sign-up
                  </p>
                </div>
