      ...
      <AppLayout title="Report submitted">
        <div className="max-w-[480px] mx-auto px-4 py-16 flex flex-col items-center text-center">
          ...
          <p className="text-sm text-gray-500 leading-relaxed max-w-xs mb-8">
            Thank you for keeping SisterRoam safe. Our safety team will review
            your report within 24 hours and follow up if needed.
          </p>
          <button
    ...
    <AppLayout title="Safety Report">
      <div className="max-w-[640px] mx-auto px-4 py-6">
        ...
        <div className="flex items-start gap-3 bg-danger-lighter rounded-xl p-4 mb-6">
          ...
          <div>
            <p className="text-sm font-semibold text-danger-dark mb-0.5">
              Confidential report
            </p>
            <p className="text-xs text-danger-dark/80 leading-relaxed">
              Your report is reviewed only by the SisterRoam safety team. We
              never share your identity with the person you&apos;re reporting
        ...
        >
          ...
          <div>
            ...
            {requestPartners.length > 0 ? (
              ...
              <input
                {...register("reportedUserId", {
                  required: "Please enter a name or user ID",
                })}
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <Icon
                        className={cn(
                          "w-4 h-4 shrink-0",
                          selected ? "text-danger" : "text-gray-400",
                        )}
                      />
                      <span
                        className={cn(
                          "text-sm font-medium",
                          selected ? "text-danger-dark" : "text-gray-800",
                        )}
                      >
                        {r.title}
                      </span>
                    ...
                    <p
                      className={cn(
                        ...
                        selected ? "text-danger-dark/70" : "text-gray-400",
                      )}
                    >
                      {r.desc}
                    </p>
          ...
          <div>
            ...
            >
              <Camera
                className={cn(
                  "w-5 h-5",
                  evidenceFile ? "text-brand" : "text-gray-300",
                )}
              />
