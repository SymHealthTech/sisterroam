...
import VerificationGate, {
  UnderReviewModal,
} from "@/components/ui/VerificationGate";
...
export default function HostListingPage() {
  ...
  return (
    <AppLayout title={hostId ? "Edit Host Listing" : "Create Host Listing"}>
      {showUnderReview && (
        <UnderReviewModal onClose={() => setShowUnderReview(false)} />
      )}
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        {/* Accommodation type */}
        <Section
          title="Accommodation type"
          description="What kind of space will you offer guests?"
        >
        ...
        <Section
          ...
          description="How many guests can you accommodate at once?"
        >
        ...
        <Section
          ...
          description="What do you provide at no extra charge?"
        >
        ...
        <Section
          title="House rules"
          description="Let guests know what to expect."
        >
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <span
                className={cn(
                  "text-[11px]",
                  houseRules.length > 900 ? "text-amber" : "text-gray-400",
                )}
              >
        ...
        {/* Languages */}
        <Section
          title="Languages for guests"
          description="Languages you can communicate with guests in."
        >
          <TagInput
            ...
            <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  Complete verification to add paid services
                </p>
                <Button
